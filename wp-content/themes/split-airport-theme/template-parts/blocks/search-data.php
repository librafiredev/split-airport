        ...
        <div class="search-data__from-to">
            ...
            <div class="search-data__from-to-destinations">
                ...
                <?php foreach ($destinations as $destination): ?>
                    <a href="<?php echo esc_url(Page::getSearchPage() . '?destination=' . $destination)?>"><?php echo $destination; ?></a>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="search-data__airline">
            ...
            <div class="search-data__airline-companies">
                ...
                <?php foreach ($airlines as $airline): ?>
                    <a href="<?php echo esc_url(Page::getSearchPage() . '?airlineCompany=' . $airline); ?>"><?php echo $airline; ?></a>
                <?php endforeach; ?>
            </div>
        </div>
