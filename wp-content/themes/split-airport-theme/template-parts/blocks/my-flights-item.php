 ...
 <div>
     ...
     <?php echo $destinationDisplay; ?> <strong><?php echo  $flight['esttime'] ? DateTimeFlight::formatTimeTableView($flight['esttime']) : DateTimeFlight::formatTimeTableView($flight['schtime']); ?></strong>
