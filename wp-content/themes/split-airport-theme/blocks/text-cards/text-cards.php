...
if( isset( $block['data']['preview_image_help'] )  ) :
    ...
    <section class="text-cards-wrapper text-cards-wrapper-1" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/dots-pattern.svg);">
