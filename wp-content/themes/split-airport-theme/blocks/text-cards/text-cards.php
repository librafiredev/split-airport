...
if( isset( $block['data']['preview_image_help'] )  ) :
    ...
    <section class="text-cards-wrapper">
        <div class="container">
                    ...
                    <div class="text-cards-items">
                        ...
                        <?php while ( have_rows('items') ) : the_row(); 
                            ...
                            ?>
                                ...
                                <div class="text-card-item text-card-item-type-<?php echo $image_type; ?>" <?php echo ( $image_type == 'background' && $image )? 'style="background-image:url('.wp_get_attachment_image_url($image['ID']).');"': ''; ?>>
                                    <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">

                                        <?php if( $image_type != 'background' && $image ): ?>

                                            <div class="text-card-item-image">
                                        ...
                                        <div class="text-card-item-text">
                                            ...
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-white.svg" alt="arrow-white" />
