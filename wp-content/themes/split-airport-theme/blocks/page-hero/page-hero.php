...
?>
    ...
    <section class="page-hero-wrapper">
        ...
        <div class="page-hero-wrapper-inner">
            <div class="page-hero-img-wrap"><div class="page-hero-img-pattern" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/hero-pattern.png);"></div><?php echo wp_get_attachment_image(get_field('background'), 'full',); ?></div>
