...
if (isset($block['data']['preview_image_help'])) :
    ...
    $should_hide_my_flights = in_array($current_page_id, $excluded_pages) || in_array($current_page_id, array_map(fn($post) => $post->ID, $hide_my_flight_button));
    ?>
                ...
                <div class="home-hero-inner">
                    ...
                    <?php if (!empty($items)): ?>
                        <div class="home-hero-items" style="max-width: <?php echo 182.5 * $corrected_count; ?>px;">
                            <svg width="186" height="176" version="1.2" viewBox="0 0 186 176" xmlns="http://www.w3.org/2000/svg" class="svg-hero-cutout-bg">
                                <path class="s0" d="m0 0v176h197.4v-2h-10.8c-4.5 0-9.1-1.9-12.2-5.2l-148.4-163.6c-3.1-3.3-7.4-5.2-11.9-5.2z"/>
                            </svg>
                                    ...
                                    <div class="home-hero-item <?php echo ($row_index > 2 || !$split_first_two_items) ? 'home-hero-item-one' : ''; ?>">
                                        <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                                            <?php if ($row_index == count($items)): ?>
                                                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 148" width="128" height="148" class="svg-hero-cutout-item">
                                                    <path id="path2" d="m0.3 0v148h119.7c6.9 0 10.6-8.2 6-13.4l-119.1-132c-1.5-1.6-3.7-2.6-6-2.6z"/>
                                                </svg>
                                            <?php endif; ?>
