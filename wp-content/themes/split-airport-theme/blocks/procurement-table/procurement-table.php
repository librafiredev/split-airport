    ...
    <div class="container">
        ...
        if (!$has_active) {
            echo $currentLanguage === 'hr'
                ? '<p>Trenutno nema postupaka jednostavne nabave u tijeku.</p>'
                : '<p>There are currently no ongoing simplified procurement procedures.</p>';
        }

        if ($has_active && ($link = get_field('link'))) : ?>
